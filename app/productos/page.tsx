...
type ProductStatus = "Activo" | "Critico" | "Inactivo";
...
const companies = ["Todas", "Sumigases", "Sudematin"];
...
const getMargin = (product: Product) => product.price - product.cost;
const getRoi = (product: Product) => Math.round((getMargin(product) / product.cost) * 100);
